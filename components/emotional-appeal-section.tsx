...
export function EmotionalAppealSection() {
  return (
    <section
      id="emotional-appeal"
      className="relative z-10 overflow-hidden rounded-t-[2.5rem] md:rounded-t-[3.5rem] shadow-[0_-12px_30px_-12px_rgba(40,50,90,0.18)] bg-[#FAF5F0]"
      style={{
    ...
    >
      ...
      <div className="relative z-10">
        {/* Part 1: The Love - with contained image */}
        <div className="px-6 pt-20 pb-12 md:pt-28 md:pb-16">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-10 md:mb-14">
              ...
              <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-medium leading-[1.1] tracking-tight text-foreground text-balance">
                There&apos;s a lot to love about our screens
              </h2>
            </div>

            {/* Contained Image */}
            <div className="relative w-full max-w-2xl mx-auto aspect-[4/3] rounded-2xl overflow-hidden shadow-xl">
              <Image
                src="/images/emotional-bg.png"
                alt="A hand gently holding a phone"
                fill
            ...
            {/* Caption below image */}
            <p className="text-lg md:text-xl text-foreground/70 leading-relaxed text-center mt-8 md:mt-10 text-balance max-w-xl mx-auto">
        ...
        {/* Part 2: The Problem */}
        <div className="px-6 py-16 md:py-24 bg-gradient-to-b from-transparent via-[#F5EDE5] to-[#EAE0D5]">
