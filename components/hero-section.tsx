...
export function HeroSection() {
  return (
    <section
      className="relative isolate z-30 flex flex-col items-center px-6 pt-[50px] md:pt-[65px] xl:pt-[140px] pb-12 md:pb-16 overflow-x-clip min-h-[calc(100svh-132px)] xl:min-h-[calc(100svh-42px)]"
