...
<div className="text-center mt-[142px] md:mt-[206px]">
        <div className="flex items-center justify-center gap-[1.5vw] mb-6 -mx-6">
          <Image
            src="/images/soberphone-logo-mark.png"
            alt=""
            width={180}
            height={260}
            className="h-[20vw] w-auto select-none"
            draggable={false}
          />
          <h2
            className="font-serif font-medium leading-[1.1] tracking-tight py-[0.18em] bg-clip-text text-transparent whitespace-nowrap select-none text-[14vw]"
            style={{
              backgroundImage:
